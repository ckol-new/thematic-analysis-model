...
import lancedb
from .dclasses import Sentence, Content, SchemaTrialOutput
...
class Loader:
    def __init__(self, lance_path: Path | str, tbl1_name: str, tbl2_name: str, tbl3_name: str):
    ...
    def first_init(self, schema1: type, schema2: type):
        ...
        tbl3 = db.create_table(name='TrialOutput', schema=SchemaTrialOutput, mode='overwrite')
    ...
    def connect(self):
        ...
        tbl3 = db.open_table(name=self.tbl3_name)
        return db, tbl1, tbl2, tbl3
